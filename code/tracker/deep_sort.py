...
class DeepSort(object):
    def __init__(self, config):
        logger.info(f"DeepSort Initialize")
        self.model_path = config["reid_checkpoint"]
        ...
        self.use_appearence = config["use_appearence"]
        ...
        try:
            ...
            logger.info(f"Succes to Load DeepSort")
        except Exception as e:
            logger.error(f"Fail to Load DeepSort: {e}", exc_info=True)
